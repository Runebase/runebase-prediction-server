...
router.post('/validate-address', (req, res, next) => {
  RunebaseUtils.validateAddress(req.body)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
router.post('/approve', (req, res, next) => {
  RunebasePredictionToken.approve(req.body)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
router.post('/allowance', (req, res, next) => {
  RunebasePredictionToken.allowance(req.body)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
router.post('/pred-balance', (req, res, next) => {
  RunebasePredictionToken.balanceOf(req.body)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
router.post('/total-runebase-value', (req, res, next) => {
  TopicEvent.totalRunebaseValue(req.body)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
...
router.post('/total-pred-value', (req, res, next) => {
  TopicEvent.totalPredValue(req.body)
    .then((result) => {
      onRequestSuccess(res, result, next);
    }, (err) => {
      onRequestError(res, err, next);
