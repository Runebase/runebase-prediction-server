...
module.exports = {
  resetApprove: async (root, data, { db: { Transactions } }) => {
    let tx = Object.assign({}, data, { type: TX_TYPE.RESETAPPROVE, token: TOKEN.PRED, amount: '0', version: 0 });

    if (needsToExecuteTx(tx)) {
      try {
        const { txid, args: { gasLimit, gasPrice } } = await RunebasePredictionToken.approve({
  ...
  approveCreateEvent: async (root, data, { db: { Transactions } }) => {
    let tx = Object.assign({}, data, { type: TX_TYPE.APPROVECREATEEVENT, token: TOKEN.PRED, version: 0 });
  ...
  createEvent: async (root, data, { db: { Topics, Oracles, Transactions } }) => {
    ...
    await DBHelper.insertTopic(Topics, {
      ...
      name,
      options,
      runebaseAmount: fill(Array(options), '0'),
      predAmount: fill(Array(options), '0'),
      escrowAmount: amount,
  ...
  createBet: async (root, data, { db: { Transactions } }) => {
    let tx = Object.assign({}, data, { type: TX_TYPE.BET, token: TOKEN.RUNEBASE, version: 0 });
  ...
  approveSetResult: async (root, data, { db: { Transactions } }) => {
    let tx = Object.assign({}, data, { type: TX_TYPE.APPROVESETRESULT, token: TOKEN.PRED, version: 0 });
  ...
  setResult: async (root, data, { db: { Transactions } }) => {
    let tx = Object.assign({}, data, { type: TX_TYPE.SETRESULT, token: TOKEN.PRED, version: 0 });
  ...
  approveVote: async (root, data, { db: { Transactions } }) => {
    let tx = Object.assign({}, data, { type: TX_TYPE.APPROVEVOTE, token: TOKEN.PRED, version: 0 });
  ...
  createVote: async (root, data, { db: { Oracles, Transactions } }) => {
    let tx = Object.assign({}, data, { type: TX_TYPE.VOTE, token: TOKEN.PRED, version: 0 });
