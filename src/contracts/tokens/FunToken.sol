...
contract FunToken is StandardToken, Ownable {
    // Token configurations
    string public constant name = "Fun Token";
    string public constant symbol = "FUN";
    uint256 public constant decimals = 8;

    uint256 public constant tokenTotalSupply = 100 * (10**6) * (10**decimals); // 100 million FUNS ever created

    // Events
    event Mint(uint256 supply, address indexed to, uint256 amount);

    /// @notice Creates new FunToken contract
