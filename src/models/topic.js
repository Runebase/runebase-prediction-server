...
class Topic {
  ...
  decode() {
    ...
    this.creatorAddress = Decoder.toRunebaseAddress(this.rawLog._creatorAddress, isMainnet());
  ...
  translate() {
    return {
      ...
      resultIdx: null,
      runebaseAmount: _.fill(Array(this.resultNames.length), '0'),
      predAmount: _.fill(Array(this.resultNames.length), '0'),
      status: 'VOTING',
      hashId: null,
      language: 'zh-Hans-CN',
    };
